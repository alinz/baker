...
import (
	...
	"github.com/alinz/bake/data"
	"github.com/alinz/bake/driver"
...
var _ driver.Watcher = (*Docker)(nil)

func (d *Docker) Start(updater driver.Updater) {
	events := make(chan *event, 10)
	containers := make(chan *data.Container, 10)
...
func (d *Docker) eventsToContainers(events <-chan *event, containers chan<- *data.Container) {
